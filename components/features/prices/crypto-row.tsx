...
function CoinBadge({ symbol }: { symbol: string }) {
  return (
    <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-secondary to-primary/10 font-mono text-[10px] font-bold uppercase text-accent ring-1 ring-accent/40 shadow-[0_0_10px_rgba(251,191,36,0.2)]">
      {symbol.slice(0, 3)}
    </span>
  )
}
...
export function CryptoRow({ coin }: {
  ...
  return (
    <div className="group grid grid-cols-[2rem_1fr_auto_auto] items-center gap-2 border-b border-primary/10 px-3 py-2.5 transition-all duration-300 hover:bg-gradient-to-r hover:from-primary/[0.08] hover:to-accent/[0.04] hover:shadow-[inset_0_0_0_1px_rgba(251,191,36,0.4),0_0_20px_rgba(251,191,36,0.1)] md:grid-cols-[3rem_1fr_9rem_7rem] md:gap-3 md:px-5 md:py-3 card-3d">
